...
def tts_batch(session_id: str = '28409f777468c87963ed7b03873a8462', text_speaker: str = 'en_us_002', req_text: str = 'TikTok Text to Speech',
...
if __name__ == "__main__":
    text = input('text: ')
    tts('28409f777468c87963ed7b03873a8462','en_uk_001', text, 'voice.mp3', True)
